<?php
/* Template Name: NovaFlow: School Principal's Enrolment Playbook */
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<title>The 2027 Principal's Enrolment Playbook, NovaFlow Digital</title>
...
<body>
  ...
  <section style="background: radial-gradient(1100px 540px at 78% -8%, #E4F4F5 0%, rgba(228,244,245,0) 60%), linear-gradient(180deg, #F7FBFC 0%, #FFFFFF 100%); padding: 56px 0 88px; overflow: hidden;">
    <div style="max-width: 1180px; margin: 0 auto; padding: 0 24px;">
      <img src="/wp-content/uploads/landers/novaflow-school-principals-playbook/assets/novaflow-logo.png" alt="NovaFlow Digital" style="height: 30px; width: auto; margin-bottom: 48px;">
      <div class="nf-hero" style="position: relative; display: grid; grid-template-columns: 1.05fr 0.95fr; gap: 48px; align-items: center;">
        <div class="nf-reveal">
          ...
          <div id="hero-form" style="background: #fff; border: 1px solid #E4EDEF; border-radius: 16px; padding: 28px; box-shadow: 0 20px 44px rgba(22,38,63,0.1); max-width: 460px;">
            <!-- ActiveCampaign embed form (placeholder: reusing the School
                 Enrolment Playbook form id 3). Swap in a dedicated form id
                 for this campaign so principal-sourced leads are tracked
                 separately in ActiveCampaign. Success behavior (thank-you
                 message / redirect) is configured in ActiveCampaign's form
                 settings, not in this page. -->
        ...
        <img src="/wp-content/uploads/landers/novaflow-school-principals-playbook/assets/checklist-mockup.png" alt="The Principal's Enrolment Playbook: cover and interior pages" class="nf-reveal nf-hover-lift nf-hero-mockup" style="width: 118%; max-width: none; height: auto; display: block; transition-delay: 0.12s;">
      </div>
    </div>
  </section>
  ...
  <section class="nf-section" style="padding: 88px 0; background: #F4F8F9;">
    <div class="nf-reveal" style="max-width: 900px; margin: 0 auto 48px; padding: 0 24px; text-align: center;">
      <h2 style="font-family: 'Poppins', sans-serif; font-weight: 800; font-size: clamp(26px, 3.2vw, 38px); letter-spacing: -0.02em; color: var(--ink, #16263F); margin: 0 0 16px;">Enrolment is a leadership problem now, not just a marketing one.</h2>
      <p style="font-size: 17px; line-height: 1.7; color: #51637A; margin: 0;">Parents research longer before enquiring. Competition between independent schools has intensified. Advertising costs continue to rise. And boards expect a clearer answer than "the campaign is running" when they ask how enrolment is tracking.</p>
    </div>
  ...
  <section class="nf-section" style="padding: 88px 0; background: var(--ink, #16263F);">
    <div class="nf-reveal" style="max-width: 760px; margin: 0 auto; padding: 0 24px; text-align: center;">
      <h2 style="font-family: 'Poppins', sans-serif; font-weight: 800; font-size: clamp(24px, 2.8vw, 32px); line-height: 1.35; letter-spacing: -0.02em; color: #fff; margin: 0 0 22px;">Most Principals only find out a campaign underperformed after the term is over.</h2>
      <p style="font-size: 17px; line-height: 1.7; color: #B7C4D3; margin: 0 0 32px;">By the time enrolment numbers land on your desk, the budget is spent and the intake is set. Most underfunded campaigns were never going to work: short bursts at half the required spend mostly buy impressions, not enrolments. The playbook explains what to look for early, and what to ask your team before it happens again.</p>
  ...
  <section class="nf-section" style="padding: 88px 0; background: #fff;">
    <div style="max-width: 1080px; margin: 0 auto; padding: 0 24px; display: grid; grid-template-columns: 0.9fr 1.1fr; gap: 56px; align-items: center;" class="nf-hero">
      ...
      <div class="nf-reveal" style="transition-delay: 0.08s;">
        ...
        <h2 style="font-family: 'Poppins', sans-serif; font-weight: 800; font-size: clamp(24px, 2.8vw, 32px); letter-spacing: -0.02em; color: var(--ink, #16263F); margin: 0 0 18px;">That's why we built this playbook for Principals.</h2>
        <p style="font-size: 16.5px; line-height: 1.7; color: #51637A; margin: 0 0 26px;">We built this playbook because we kept meeting Principals who were personally accountable for enrolment numbers, without a straightforward way to judge whether the marketing behind them was actually working. Every framework on the next page is drawn directly from work we've done with schools like the one above: enough to ask sharper questions of your team or agency, and enough to explain the plan to your board in plain terms.</p>
        <a href="#top" onclick="document.getElementById('hero-form').scrollIntoView({behavior:'smooth',block:'center'});return false;" style="display: inline-flex; align-items: center; gap: 9px; background: var(--accent, #15A6AE); color: #fff; font-family: 'Poppins', sans-serif; font-weight: 700; font-size: 15.5px; padding: 14px 28px; border-radius: 10px; text-decoration: none;" style-hover="background: var(--accent-dark, #0E8C93);">Get My Free Playbook</a>
      </div>
    </div>
  </section>
  ...
  <section class="nf-section" style="padding: 88px 0; background: #F4F8F9;">
    <div style="max-width: 900px; margin: 0 auto; padding: 0 24px; text-align: center;">
      <h2 class="nf-reveal" style="font-family: 'Poppins', sans-serif; font-weight: 800; font-size: clamp(26px, 3.2vw, 38px); line-height: 1.15; letter-spacing: -0.02em; color: var(--ink, #16263F); margin: 0 0 16px; text-wrap: balance;">Built for Principals accountable for enrolment growth.</h2>
      <p class="nf-reveal" style="font-size: 18px; line-height: 1.7; margin: 0 0 44px; transition-delay: 0.06s;">Built for Principals and Heads of School at Australian independent schools who need to oversee enrolment marketing, not run it day to day: especially if your school is facing rising ad costs, longer parent decision cycles or a shrinking student pool.</p>
      <div class="nf-who-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; text-align: left; margin-bottom: 24px;">
        <div class="nf-reveal nf-hover-lift" style="display: flex; gap: 16px; align-items: flex-start; background: #fff; border-top: 3px solid #E9A23B; border-radius: 14px; padding: 24px; box-shadow: 0 0 0 rgba(22,38,63,0);" style-hover="box-shadow: 0 14px 30px rgba(22,38,63,0.1);">
          ...
          <div><div style="font-family: 'Poppins', sans-serif; font-weight: 700; font-size: 12px; letter-spacing: 0.04em; text-transform: uppercase; color: #E9A23B; margin-bottom: 6px;">Principals &amp; Heads of School</div><span style="font-size: 15.5px; color: #2F3F52; font-weight: 500; line-height: 1.5;">Accountable to the board for enrolment outcomes</span></div>
        </div>
        <div class="nf-reveal nf-hover-lift" style="display: flex; gap: 16px; align-items: flex-start; background: #fff; border-top: 3px solid var(--accent, #15A6AE); border-radius: 14px; padding: 24px; box-shadow: 0 0 0 rgba(22,38,63,0); transition-delay: 0.06s;" style-hover="box-shadow: 0 14px 30px rgba(22,38,63,0.1);">
          ...
          <div><div style="font-family: 'Poppins', sans-serif; font-weight: 700; font-size: 12px; letter-spacing: 0.04em; text-transform: uppercase; color: var(--accent-dark, #0E8C93); margin-bottom: 6px;">Your Marketing &amp; Enrolment Staff</div><span style="font-size: 15.5px; color: #2F3F52; font-weight: 500; line-height: 1.5;">Running the day-to-day campaign calendar</span></div>
        </div>
      </div>
  ...
  <section class="nf-section" style="padding: 88px 0; background: #fff;">
    <div style="max-width: 1080px; margin: 0 auto; padding: 0 24px;">
      <div class="nf-reveal" style="text-align: center; margin-bottom: 48px;">
        ...
        <h2 style="font-family: 'Poppins', sans-serif; font-weight: 800; font-size: clamp(24px, 2.8vw, 34px); letter-spacing: -0.02em; color: var(--ink, #16263F); margin: 0;">Everything you need to oversee a stronger enrolment year.</h2>
      </div>
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 48px; align-items: center;" class="nf-hero">
        ...
        <div class="nf-reveal" style="display: flex; flex-direction: column; gap: 20px; transition-delay: 0.1s;">
          ...
          <div style="display: flex; gap: 14px; align-items: flex-start;"><span style="flex: none; width: 8px; height: 8px; border-radius: 50%; background: var(--accent, #15A6AE); margin-top: 8px;"></span><span style="font-size: 15.5px; color: #2F3F52; line-height: 1.5;"><strong style="color: var(--ink, #16263F);">Sign off on spend with confidence</strong>: the Budget Reality Check, what schools actually spend, and why bursts cost more</span></div>
          <div style="display: flex; gap: 14px; align-items: flex-start;"><span style="flex: none; width: 8px; height: 8px; border-radius: 50%; background: var(--accent, #15A6AE); margin-top: 8px;"></span><span style="font-size: 15.5px; color: #2F3F52; line-height: 1.5;"><strong style="color: var(--ink, #16263F);">Know what questions to ask your team</strong>: the Conversion Checklist, 41 practical items across landing pages, forms and tracking</span></div>
  ...
  <section class="nf-section" style="padding: 88px 0; background: #F4F8F9;">
    <div style="max-width: 1080px; margin: 0 auto; padding: 0 24px; display: grid; grid-template-columns: 1fr 1fr; gap: 56px; align-items: center;" class="nf-hero">
      <img src="/wp-content/uploads/landers/novaflow-school-principals-playbook/assets/team-planning.jpg" alt="School leadership team planning an Open Day campaign" class="nf-reveal" style="width: 100%; aspect-ratio: 4/3; object-fit: cover; border-radius: 20px; display: block;">
      <div class="nf-reveal" style="transition-delay: 0.08s;">
        <div style="font-family: 'Poppins', sans-serif; font-weight: 700; font-size: 12.5px; letter-spacing: 0.14em; text-transform: uppercase; color: var(--accent-dark, #0E8C93); margin-bottom: 14px;">Built with real Principals</div>
        <h2 style="font-family: 'Poppins', sans-serif; font-weight: 800; font-size: clamp(24px, 2.8vw, 32px); letter-spacing: -0.02em; color: var(--ink, #16263F); margin: 0 0 18px;">Every framework was tested inside a real school leadership team.</h2>
        <p style="font-size: 16.5px; line-height: 1.7; color: #51637A; margin: 0;">Not written from the outside looking in. The planner, the blueprint and the checklist are the same tools we use sitting across the table from Principals and business managers every term, translated into what a Principal actually needs to know without running the campaigns themselves.</p>
      </div>
    </div>
  </section>
  ...
  <section class="nf-section" style="padding: 88px 0; background: #fff;">
    <div class="nf-reveal" style="max-width: 760px; margin: 0 auto; padding: 0 24px; text-align: center;">
      ...
      <div style="background: #F4F8F9; border-radius: 20px; padding: 40px 36px; text-align: left; display: flex; flex-direction: column; gap: 24px;">
        <div style="display: flex; gap: 12px; align-items: flex-start;"><span style="flex: none; color: var(--accent, #15A6AE); font-weight: 700; font-size: 16px;">✓</span><span style="font-size: 16.5px; color: var(--ink, #16263F); font-weight: 500; line-height: 1.5;">Sign off on your school's enrolment marketing plan with confidence.</span></div>
        <div style="display: flex; gap: 12px; align-items: flex-start;"><span style="flex: none; color: var(--accent, #15A6AE); font-weight: 700; font-size: 16px;">✓</span><span style="font-size: 16.5px; color: var(--ink, #16263F); font-weight: 500; line-height: 1.5;">Ask your marketing team or agency the right questions.</span></div>
        <div style="display: flex; gap: 12px; align-items: flex-start;"><span style="flex: none; color: var(--accent, #15A6AE); font-weight: 700; font-size: 16px;">✓</span><span style="font-size: 16.5px; color: var(--ink, #16263F); font-weight: 500; line-height: 1.5;">Spot a weak or underfunded campaign before it costs you a term.</span></div>
        <div style="display: flex; gap: 12px; align-items: flex-start;"><span style="flex: none; color: var(--accent, #15A6AE); font-weight: 700; font-size: 16px;">✓</span><span style="font-size: 16.5px; color: var(--ink, #16263F); font-weight: 500; line-height: 1.5;">Report enrolment performance to your board with real numbers.</span></div>
        <div style="display: flex; gap: 12px; align-items: flex-start;"><span style="flex: none; color: var(--accent, #15A6AE); font-weight: 700; font-size: 16px;">✓</span><span style="font-size: 16.5px; color: var(--ink, #16263F); font-weight: 500; line-height: 1.5;">Build a repeatable enrolment system your team can run without you having to check in every week.</span></div>
      </div>
  ...
  <section class="nf-section" style="padding: 88px 0; background: #F4F8F9;">
    <div class="nf-reveal" style="max-width: 760px; margin: 0 auto; padding: 0 24px;">
      <div style="text-align: center; margin-bottom: 36px;">
        ...
        <h2 style="font-family: 'Poppins', sans-serif; font-weight: 800; font-size: clamp(24px, 2.8vw, 32px); letter-spacing: -0.02em; color: var(--ink, #16263F); margin: 0 0 10px;">Score your oversight. Honestly.</h2>
      ...
      <div style="background: #F4F8F9; border-radius: 16px; padding: 28px 32px; display: flex; flex-direction: column;">
          <div class="sc-row" data-q="1" style="display: flex; align-items: center; gap: 16px; padding: 16px 0; border-bottom: 1px solid #E4EDEF;">
            ...
            <div style="flex: 1; font-size: 15.5px; color: #16263F; font-weight: 500; line-height: 1.5;">Could you show your board a written 12-month enrolment marketing calendar today?</div>
          ...
          <div class="sc-row" data-q="2" style="display: flex; align-items: center; gap: 16px; padding: 16px 0; border-bottom: 1px solid #E4EDEF;">
            ...
            <div style="flex: 1; font-size: 15.5px; color: #16263F; font-weight: 500; line-height: 1.5;">Do you know how long your Open Day campaigns actually run for, without asking your team?</div>
            <div style="display: flex; gap: 8px; flex: none;">
          ...
          <div class="sc-row" data-q="3" style="display: flex; align-items: center; gap: 16px; padding: 16px 0; border-bottom: 1px solid #E4EDEF;">
            ...
            <div style="flex: 1; font-size: 15.5px; color: #16263F; font-weight: 500; line-height: 1.5;">Could you explain your school's cost per enrolment to the board without checking with anyone first?</div>
            <div style="display: flex; gap: 8px; flex: none;">
      ...
      <div class="nf-credibility-grid" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 24px;">
        <div class="nf-reveal nf-hover-lift" style="background: #F4F8F9; border: 2px solid var(--accent, #15A6AE); border-radius: 18px; padding: 40px 34px; display: flex; flex-direction: column; justify-content: space-between;" style-hover="box-shadow: 0 18px 36px rgba(22,38,63,0.14);">
          ...
          <div style="display: flex; align-items: center; gap: 12px;">
            <img src="/wp-content/uploads/landers/novaflow-school-principals-playbook/assets/testimonial-alice-thompson.jpg" alt="Alice Thompson" style="width: 42px; height: 42px; border-radius: 50%; object-fit: cover; flex: none;">
        ...
        <div class="nf-reveal nf-hover-lift" style="background: #F4F8F9; border: 1px solid #E4EDEF; border-radius: 18px; padding: 40px 34px; display: flex; flex-direction: column; justify-content: space-between; transition-delay: 0.08s;" style-hover="box-shadow: 0 18px 36px rgba(22,38,63,0.1);">
          ...
          <div style="display: flex; align-items: center; gap: 12px;">
            <img src="/wp-content/uploads/landers/novaflow-school-principals-playbook/assets/testimonial-emma-velthuis.jpg" alt="Emma Velthuis" style="width: 42px; height: 42px; border-radius: 50%; object-fit: cover; flex: none;">
        ...
        <div class="nf-reveal nf-hover-lift" style="background: #F4F8F9; border: 1px solid #E4EDEF; border-radius: 18px; padding: 40px 34px; display: flex; flex-direction: column; justify-content: space-between; transition-delay: 0.16s;" style-hover="box-shadow: 0 18px 36px rgba(22,38,63,0.1);">
          ...
          <div style="display: flex; align-items: center; gap: 12px;">
            <img src="/wp-content/uploads/landers/novaflow-school-principals-playbook/assets/testimonial-susanna-rossetto.jpg" alt="Susanna Rossetto" style="width: 42px; height: 42px; border-radius: 50%; object-fit: cover; flex: none;">
    ...
    <div style="max-width: 1080px; margin: 0 auto; padding: 0 24px; display: grid; grid-template-columns: 1fr 1fr; gap: 56px; align-items: start;" class="nf-hero">
      ...
      <div class="nf-reveal" style="transition-delay: 0.08s;">
        ...
        <div style="background: #F4F8F9; border-radius: 20px; padding: 24px; position: relative; display: flex; align-items: center; justify-content: center;">
          <img src="/wp-content/uploads/landers/novaflow-school-principals-playbook/assets/checklist-mockup.png" alt="The Principal's Enrolment Playbook: cover and interior pages" style="width: 100%; height: auto; display: block; border-radius: 10px;">
        </div>
  ...
  <section style="background: var(--ink, #16263F); padding: 88px 0;">
    <div class="nf-final-cta" style="max-width: 1080px; margin: 0 auto; padding: 0 24px; display: grid; grid-template-columns: 1fr 1fr; gap: 48px; align-items: center;">
      <div class="nf-reveal">
        <h2 style="font-family: 'Poppins', sans-serif; font-weight: 800; font-size: clamp(26px, 3vw, 36px); line-height: 1.25; letter-spacing: -0.02em; color: #fff; margin: 0 0 18px; text-wrap: balance;">Give your board a plan they can trust.</h2>
        <p style="font-size: 16.5px; line-height: 1.6; color: #B7C4D3; margin: 0 0 30px; max-width: 420px;">Get your free playbook today so you can walk into your next leadership meeting with a clear view of what your enrolment marketing should look like.</p>
      ...
      <div id="final-form" class="nf-reveal" style="background: #fff; border-radius: 18px; padding: 36px; box-shadow: 0 24px 50px rgba(0,0,0,0.28); transition-delay: 0.1s;">
        <!-- ActiveCampaign embed form (placeholder, same id 3 as the hero
             form above). ActiveCampaign supports the same embed snippet
             appearing more than once on a page. -->
        <div class="_form_3"></div><script src="https://novaflowdigital.activehosted.com/f/embed.php?id=3" charset="utf-8"></script>
    ...
    <p style="text-align: center; font-size: 12.5px; color: #7E8FA2; padding: 32px 24px 0;">© 2027 NovaFlow Digital. Trusted by 70+ Australian Schools.</p>
  </section>
